function Build-Solution {
    ...
    begin {
        ...
        [string] $msbuildFilePath = 'C:\Program Files\Microsoft Visual Studio\2022\Enterprise\MSBuild\Current\Bin\msbuild.exe'
        [string] $VSToolsPath = 'C:\Program Files\Microsoft Visual Studio\2022\Enterprise\MSBuild\Microsoft\VisualStudio\v17.0'
    }
